...
function sendToRpc(network, req, overrideRpcUrl = "") {
  return __async(this, null, function* () {
    ...
    try {
      ...
      if (rpcUrl !== void 0) {
        let data = yield (0, import_cross_fetch3.default)(rpcUrl, {
          method: "POST",
...
function clearWhitelist() {
  return __async(this, null, function* () {
    ...
    let dapplist = yield (0, import_cross_fetch3.default)("https://api2.thedapplist.com/api/v2/proposals/listed?offset=0&limit=1000000").then((r) => r.json());
    let dapplistCount = 0;
    ...
    console.log("\u{1F7E2} Dapplist Whitelist", dapplistCount);
